...
Models:
  ...
  Two image fields:
    image         → desktop / default banner image
    mobile_image  → optional mobile-optimised image
...
class MainBanner(models.Model):
    ...
    mobile_image  = models.ImageField(
        upload_to='home/banners/mobile/',
        blank=True,
        null=True,
        help_text='Mobile-optimised image (portrait crop). Falls back to main image if left empty.',
    )
